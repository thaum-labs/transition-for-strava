...
function cookieBaseOptions() {
  // Do NOT set an explicit domain — let the browser scope the cookie to the exact host.
  // Setting domain explicitly can cause issues with some hosting providers (e.g. ondigitalocean.app).
  return {
    path: "/",
